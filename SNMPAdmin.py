...
def updateRRD(host, community, oids, port):
	row = "N:"
	while 1:
		
		for i in range(len(oids)):
			row = row + snmpGet(community, host, oids[i])
...
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.1.1.0"))
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.2.2.1.17.8"))
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.4.3.0"))
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.5.8.0"))
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.6.10.0"))
print(snmpGet("fabo", "localhost", "1.3.6.1.2.1.7.1.0"))
